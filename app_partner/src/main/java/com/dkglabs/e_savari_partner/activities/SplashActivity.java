...
import com.dkglabs.e_savari_partner.databinding.ActivitySplashBinding;
import com.dkglabs.e_savari_partner.viewmodel.SplashViewModel;
    ...
    public void onResponse(int requestCode, BaseResponse response) {
        switch (requestCode) {
            ...
            case 1002:
                ...
                validateUserType(userResponse.getUserType());
                break;
        }
    }
