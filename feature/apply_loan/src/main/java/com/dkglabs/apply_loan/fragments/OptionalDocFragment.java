...
import com.dkglabs.apply_loan.databinding.FragmentOptionalDocBinding;
...
public class OptionalDocFragment extends BaseFragment implements View.OnClickListener, ResponseListener {

    private List<DocDetails> docDetailsList;

    private DocAdapter adapter;
    private FragmentOptionalDocBinding binding;
    private int position = -1;

    public OptionalDocFragment() {
        // Required empty public constructor
    }

    public static OptionalDocFragment newInstance(Bundle args) {
        OptionalDocFragment fragment = new OptionalDocFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentOptionalDocBinding.inflate(getLayoutInflater(), container, false);
        initializeView();
