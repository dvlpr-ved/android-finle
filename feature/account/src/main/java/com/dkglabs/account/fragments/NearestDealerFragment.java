...
import com.dkglabs.account.adapters.DealerAdapter;
import com.dkglabs.account.databinding.FragmentNearestDealerBinding;
...
public class NearestDealerFragment extends BaseFragment implements MenuProvider {

    private List<DealerResponse> dealerList;
    private DealerAdapter adapter;

    private FragmentNearestDealerBinding binding = null;

    public NearestDealerFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNearestDealerBinding.inflate(getLayoutInflater(), container, false);
        initializeView();
    ...
    private void initializeView() {
        setUpBackToolbar(getString(R.string.text_nearest_dealer));
